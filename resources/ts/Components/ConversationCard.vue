    ...
    <li class="p-2 border-bottom border-top" :class="{ 'bg-primary': $page.url === `/sms-communications/conversations/${conversation.id}` }">
        ...
        >
            <div class="d-flex flex-row">
                <div>
                    <div class="avatar rounded-circle d-flex me-3 shadow-1-strong white-text mr-4" style="width: 60px; height: 60px" :class="getAvatarColor()">
                ...
                <div class="pt-1">
                    ...
                    <template v-if="props.conversation.messages.length > 0">
                        <template v-if="props.conversation.messages.slice(-1)[0].message_type == 'text'">
                            <p v-if="conversation.messages.length > 0" class="small">{{ lastTextMessage }}</p>
                        </template>
            ...
            <div class="d-flex flex-row pt-1 text-primary">
                ...
                <span class="mx-1 pt-1">{{conversation.account_phone_number.account.name}}</span>
...
const lastTextMessage = computed(() => {
    ...
    return (lastMessage.body && lastMessage.body.length > 60)
